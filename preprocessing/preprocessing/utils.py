...
class BaseTextCategorizationDataset:
    ...
    def get_index_to_label_map(self):
        ...
        """
        # TODO: CODE HERE
        return {index: value for index, value in enumerate(self._get_label_list())}
    ...
    def get_label_to_index_map(self):
        ...
        """
        # TODO: CODE HERE
        return {value: index for index, value in self.get_index_to_label_map().items()}
...
class LocalTextCategorizationDataset(BaseTextCategorizationDataset):
    ...
    def __init__(self, filename, batch_size,
        ...
        self._label_list = list(set(self._dataset['tag_name'].values))
